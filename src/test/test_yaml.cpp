...
YAML_CASE("test-data/calllocal.yaml", abstract_domain_kind::EBPF_DOMAIN)
...
YAML_CASE("test-data/muldiv.yaml", abstract_domain_kind::EBPF_DOMAIN)
...
YAML_CASE("test-data/pointer.yaml", abstract_domain_kind::EBPF_DOMAIN)
...
YAML_CASE("test-data/uninit.yaml", abstract_domain_kind::EBPF_DOMAIN)
