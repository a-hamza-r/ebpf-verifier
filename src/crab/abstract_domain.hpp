...
class abstract_domain_t {
  private:
    class abstract_domain_concept {
      public:
        ...
        virtual bool operator<=(const abstract_domain_concept& abs) = 0;
        ...
        virtual void operator()(const Mem&, location_t) = 0;
        ...
        virtual void print_state_init(std::ostream&, label_t) const = 0;
    ...
    class abstract_domain_model final : public abstract_domain_concept {
      ...
      public:
        ...
        bool operator<=(const abstract_domain_concept& abs) override;
        ...
        void print_state_init(std::ostream&, label_t) const override;
  ...
  public:
    ...
    bool is_top() const;
    bool operator<=(const abstract_domain_t& abs);
