...
void print_numeric_register(std::ostream&, Reg, crab::refinement_t, bool, 
...
void print_register(std::ostream&, Reg, const std::optional<crab::ptr_or_mapfd_t>&,
        const std::optional<crab::refinement_t>&, const std::optional<crab::refinement_t>&, bool,
                    std::shared_ptr<crab::slacks_t>);
...
void print_annotated(std::ostream&, const Call&, std::optional<crab::ptr_or_mapfd_t>&,
        std::optional<crab::refinement_t>&, std::optional<crab::refinement_t>&, bool,
                     std::shared_ptr<crab::slacks_t>);
...
void print_annotated(std::ostream&, const Mem&, std::optional<crab::ptr_or_mapfd_t>&,
        std::optional<crab::refinement_t>&, std::optional<crab::refinement_t>&, bool,
                     std::shared_ptr<crab::slacks_t>);
void print_annotated(std::ostream&, const Un&, std::optional<crab::refinement_t>&, bool,
                     std::shared_ptr<crab::slacks_t>);
