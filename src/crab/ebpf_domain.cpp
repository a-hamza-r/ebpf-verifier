...
void ebpf_domain_t::operator()(const FuncConstraint& s, location_t loc) {
...
void ebpf_domain_t::operator()(const ValidCall& s, location_t loc) {
...
void ebpf_domain_t::operator()(const Atomic& a, location_t loc) {
    if (m_inv.is_bottom()) {
        return;
    }
...
void ebpf_domain_t::operator()(const CallLocal& call, location_t loc) {
    using namespace crab::dsl_syntax;
    if (m_inv.is_bottom()) {
        return;
    }
...
void ebpf_domain_t::operator()(const Callx& callx, location_t loc) {
    using namespace crab::dsl_syntax;
    if (m_inv.is_bottom()) {
        return;
    }
...
void ebpf_domain_t::operator()(const IncrementLoopCounter& ins, location_t loc) {
