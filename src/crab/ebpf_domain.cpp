...
void ebpf_domain_t::operator()(const Atomic& a, location_t loc, int print) {
    if (m_inv.is_bottom())
        return;
...
void ebpf_domain_t::operator()(const Callx& callx, location_t loc, int print) {
    using namespace crab::dsl_syntax;
    if (m_inv.is_bottom())
        return;
...
void ebpf_domain_t::operator()(const IncrementLoopCounter& ins, location_t loc, int print) {
