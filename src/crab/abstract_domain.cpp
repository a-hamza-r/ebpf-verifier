...
template <typename Domain>
std::unique_ptr<abstract_domain_t::abstract_domain_concept>
abstract_domain_t::abstract_domain_model<Domain>::widen(const abstract_domain_t::abstract_domain_concept& abs, bool to_constants) {
    std::unique_ptr<abstract_domain_t::abstract_domain_concept> res(
        new abstract_domain_t::abstract_domain_model<Domain>(
            m_abs_val.widen(static_cast<const abstract_domain_t::abstract_domain_model<Domain>*>(&abs)->m_abs_val, to_constants)));
    return std::move(res);
}
...
template <typename Domain>
void abstract_domain_t::abstract_domain_model<Domain>::print_state_init(std::ostream& o, label_t l) const {
    m_abs_val.print_state_init(o, l);
}
...
crab::bound_t abstract_domain_t::abstract_domain_model<Domain>::get_loop_count_upper_bound() const {
    return m_abs_val.get_loop_count_upper_bound();
}

template <typename Domain>
void abstract_domain_t::abstract_domain_model<Domain>::initialize_loop_counter(const label_t label) {
    m_abs_val.initialize_loop_counter(label);
}
...
bool abstract_domain_t::operator<=(const abstract_domain_t& abs) {
...
abstract_domain_t abstract_domain_t::widen(const abstract_domain_t& abs, bool to_constants) {
    return abstract_domain_t(std::move(m_concept->widen(*(abs.m_concept), to_constants)));
}
...
void abstract_domain_t::initialize_loop_counter(const label_t label) { m_concept->initialize_loop_counter(label); }
...
void abstract_domain_t::print_state_init(std::ostream& o, label_t l) const {
    m_concept->print_state_init(o, l);
}
